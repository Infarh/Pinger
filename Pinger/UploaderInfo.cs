...
[DebuggerDisplay("{Login}({Type})")]
public class UploaderInfo
{
    /// <summary>Логин загрузчика</summary>
    [JsonPropertyName("login")]
    public string Login { get; init; } = null!;

    /// <summary>ID загрузчика</summary>
    [JsonPropertyName("id")]
    public int Id { get; init; }

    /// <summary>Node ID загрузчика</summary>
    ...
    /// <summary>URL загрузчика</summary>
    [JsonPropertyName("url")]
    public Uri Url { get; init; } = null!;

    /// <summary>HTML URL загрузчика</summary>
